      ...
      <div className="common-services-card p-lg-5">
        <div className="row g-4">
              ...
              <div className="swiper product-main mb-3">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <img src="./assets/img/cpu-img.jpg" alt="" />
                  </div>
                  <div className="swiper-slide">
                    <img src="./assets/img/pc-img.jpg" alt="" />
                  </div>
                  <div className="swiper-slide">
                    <img src="./assets/img/cpu-components-img.jpg" alt="" />
                  </div>
                  <div className="swiper-slide">
                    <img src="./assets/img/computer-comp-img.jpg" alt="" />
                  </div>
                  <div className="swiper-slide">
                    <img src="./assets/img/cpu-img.jpg" alt="" />
                  </div>
          ...
          <div className="col-md-6">
            ...
            <p className="mb-3">
              <strong>Product Code:</strong> Lorem ipsum
            </p>
            <div className="hot-deal-form mb-5">
            ...
            <div className="row align-items-center justify-content-end gy-4 ">
